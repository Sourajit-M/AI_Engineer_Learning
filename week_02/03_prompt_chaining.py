...
def step1_resume_skills(RESUME):
    print("STEP 1")
    system_prompt = """
    ...
    user_prompt = f"""
    Extract the skills from the resume {RESUME}
    """
...
def step2_JD_extract(JD):
    ...
    user_prompt = f"""
    Extract the skills from the job description {JD}
    """
...
candidate = step1_resume_skills(RESUME)
print(candidate)
sleep(2)
